...
try:
    df = pd.read_csv("C:\Users\Administrator\OneDrive\Documents\Desktop\5G-Data-Predictor-Xgboost-main\5G-Data-Predictor-Xgboost-main\5G_Data_Usage_Prediction_Enhanced.csv")
except FileNotFoundError:
    df = None
